  ...
  return (
    <div className="app__gallery flex__center">
      <div className="app__gallery-content">
        ...
        <p className="p__opensans" style={{ color: '#AAAAAA', marginTop: '2rem' }}>Her ses et lille udpluk af menuen fra vores Instagram. Klik på nedenstående knap for at se mere.</p>
        ...
        <div className="app__gallery-images_container" ref={scrollRef}>
          {Images.map((item, index) => (
            <div className="app__gallery-images_card flex__center" key={`gallery_image-${index + 1}`}>
              ...
              <BsInstagram className="gallery__image-icon" href='https://www.instagram.com/tinsfoods_/' />
            </div>
          ))}
        </div>
